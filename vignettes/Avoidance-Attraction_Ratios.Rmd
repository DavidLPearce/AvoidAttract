...
# It does, let's do the other prey species.

# Reshape data to long format #################
jrabbit_ratios_long <- tidyr::gather(jrabbit_ratios, key = "Interaction", value = "Value")
...
```{r plotting fig.width=8, fig.height=8}
...
We can see from the plots that none of the T2/T1 values are >1. This suggests that none of the predator species are actively seeking out the prey species. But all of the T4/T3 values were >1 which suggests that the prey are avoiding the area after one of the predators was detected. 
