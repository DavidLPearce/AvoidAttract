...
#' @param speciesA The first species in the interaction sequence (preceding and succeeding species).
#' @param speciesB The second species in the interaction sequence (intervening species).
...
#'   \describe{
#'     \item{total_summary}{A summary of the mean values for T4 across all sites and years.}
#'     \item{event_count}{The total count of T4 events across all sites and years.}
#'     \item{site_summary}{A summary of the mean T4 values for each site across all years.}
#'     \item{detailed_summary}{Detailed information on T4 events, including site, year, and time differences.}
#'   }
#'
#' @references
